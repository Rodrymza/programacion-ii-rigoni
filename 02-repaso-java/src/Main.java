...
public class Main {
    ...
    public static void ejercicio03() {
        ...
        int numberA = pedirnumero("Ingrese el primer numero");
        int numberB = pedirnumero("Ingrese el segundo numero");
    ...
    public static void ejercicio05() {
        int number = pedirnumero("Ingrese un numero");
    ...
    public static void ejercicio06() {
        ...
        int numberA = pedirnumero("Ingresa el primer numero");
        int numberB = pedirnumero("Ingresa el segundo numero");
    ...
    public static void ejercicio07() {
        ...
        int age = pedirnumero("Ingrese su edad");
        if (age < 0 || age > 110) {
    ...
    public static void ejercicio08() {
        ...
        //correspondiente.
        int number = pedirnumero("Ingrese un numero del 1 al 7");
        String mensaje = "";
        switch (number) {
            case 1:
                mensaje = "Lunes";
    ...
    public static void ejercicio09() {
        ...
        int numero = pedirnumero("Ingrese un numero cualquiera");
    ...
    public static void ejercicio10() {
        ...
        int salariobase = pedirnumero("Ingrese salario base");
        double valorHora = salariobase / jornadaLaboral;

        int cantidadHorasExtras = pedirnumero("Ingrese el total de horas extras trabajadas");
